...
export function apiProjectsPost$Plain(http: HttpClient, rootUrl: string, params?: ApiProjectsPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Project>> {
